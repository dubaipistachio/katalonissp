...
WebUI.setText(findTestObject('Object Repository/Page_/input_Email'), 
    'superadmin@test.com')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_/input_Password'), 
    '/+uEtD8cU9D6zpMUAnzaOw==')
